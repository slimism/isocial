...
ALLOWED_HOSTS = ['isocial-production.up.railway.app', 'https://isocial-production.up.railway.app', 'localhost']
CSRF_TRUSTED_ORIGINS = ['https://isocial-production.up.railway.app']
